...
def import_app():
    ...
    print("[+] Registering BEJSON Unified Editor in database...")
    app_name = "BEJSON Unified Editor v1.1.3"
    app_desc = "The most advanced BEJSON editor featuring Gemini 3.1 Pro integration, AES-256-GCM encryption, and multi-pane IDE layout."
    
    app_uuid = cms.create_app(
        name=app_name,
        description=app_desc,
        category_fk="apps",
        featured_img="unified-editor-v113.png",
    ...
    source_html = Path("/storage/emulated/0/dev/Projects/BEJSON_Unified_Editor/BEJSON_Unified_Editor_v1.1.3.html")
