...
def add_standardization():
    ...
    # 4. Create Page
    print("[+] Creating Gemini Schema Standardization showcase page...")
    content_data = {
        "html_body": "<p>This page defines the <strong>Official 2026 Gemini Schema Standards</strong> for the BEJSON ecosystem. It includes the standardized profile for AI behavior, the 10-slot key registry for Round Robin rotation, and the active model registry.</p>",
        "source_files": source_files
    }
    
    cms.create_page(
        title="Gemini Schema Standardization",
    ...
    cms.repack_system()
    print("[SUCCESS] Standardization page added.")
